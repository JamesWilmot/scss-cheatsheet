...
\begin{center}
     \Large{\textbf{\textsc{scss} Syntax Cheat Sheet}} \\
\end{center}

Sass (syntactically awesome stylesheets) is a scripting language which is
compiled into \textsc{css}. There exists two Sass syntaxes: \textsc{scss} and
the older \textsc{sass}.
\\
This is a cheatsheet for the newer \textsc{scss} syntax.
